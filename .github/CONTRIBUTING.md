...
- In [../main/main.ts](../main/main.ts) and [../electron-builder.config.js](../electron-builder.config.js), use your own app ID (e.g. `com.yourusername.onyx` instead of `com.lasikiewicz.onyx`).
- In [../electron-builder.config.js](../electron-builder.config.js), set `publish.owner` and `publish.repo` to your GitHub user/org and repo name.
