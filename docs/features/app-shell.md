...
15. [`RightClickMenuHeader.tsx`](../../renderer/src/components/rightClickMenu/RightClickMenuHeader.tsx) now owns the shared top action row, including flip-view, focused-section tabs, menu-transparency, and reset/default entry points.
16. [`RightClickMenuViewModeSwitch.tsx`](../../renderer/src/components/rightClickMenu/RightClickMenuViewModeSwitch.tsx) now owns the shared row of mode-toggle buttons for grid, list, logo, carousel, and cover flow.
