...
5. Controller navigation is currently gated off in [App.tsx](../../renderer/src/App.tsx); the existing hook and preferences remain ready for future re-enablement.
