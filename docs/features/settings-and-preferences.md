...
- Runtime application of settings happens in [App.tsx](../../renderer/src/App.tsx), [useAppPreferences.ts](../../renderer/src/hooks/useAppPreferences.ts), [useSettingsSaveRefresh.ts](../../renderer/src/hooks/useSettingsSaveRefresh.ts), [usePreferenceWriter.ts](../../renderer/src/hooks/usePreferenceWriter.ts), Electron bootstrap code, metadata services, import services, and launcher flows.
