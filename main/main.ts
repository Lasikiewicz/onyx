...
const metadataFetcher = new MetadataFetcherService(null, steamService, null, null);
...
registerAppIPCHandlers({ get current() { return win; } }, gameStore, imageCacheService, userPreferencesService, appConfigService, apiCredentialsService, steamAuthService, bugReportService);
