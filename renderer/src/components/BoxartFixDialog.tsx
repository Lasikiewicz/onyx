                    ...
                    <div className="space-y-4 animate-in slide-in-from-top-2 duration-300">
                      ...
                      <div className="flex gap-2">
                        <div className="relative flex-1">
                          ...
                          />
                          <svg className="absolute left-3 top-2.5 w-4 h-4 text-gray-500 group- hover:animate-wobble group-hover:animate-wobble" fill="none" stroke="currentColor" viewBox="0 0 24 24">
