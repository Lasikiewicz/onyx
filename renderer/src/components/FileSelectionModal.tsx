                    ...
                    >
                      ...
                      {activeTab !== 'imported' && (
                        ...
                        >
                          ...
                          >
                            {isSelected && (
                              <svg className="w-4 h-4 text-white group- hover:animate-wobble group-hover:animate-wobble" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="relative overflow-hidden rounded flex-shrink-0" style={{ width: '120px', height: '180px' }}>
                        {boxArtUrl ? (
                          ...
                          >
                            {isFetching ? (
                              <svg className="animate-spin h-8 w-8 text-gray-400 group- hover:animate-wobble group-hover:animate-wobble" fill="none" viewBox="0 0 24 24">
