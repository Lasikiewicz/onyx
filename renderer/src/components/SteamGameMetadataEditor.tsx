      ...
      <div className="bg-gray-800 rounded-lg shadow-xl w-full max-w-7xl mx-4 border border-gray-700 max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            >
              <svg className="w-6 h-6 group- hover:animate-wobble group-hover:animate-wobble" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
            ...
            <div>
              {isSearching ? (
                <div className="text-center py-8">
                  <svg className="animate-spin h-8 w-8 text-blue-500 mx-auto mb-4 group- hover:animate-wobble group-hover:animate-wobble" fill="none" viewBox="0 0 24 24">
                        ...
                        >
                          ...
                          {isSelected && (
                            <div className="flex-shrink-0">
                              <svg className="w-6 h-6 text-blue-500 group- hover:animate-wobble group-hover:animate-wobble" fill="currentColor" viewBox="0 0 20 20">
