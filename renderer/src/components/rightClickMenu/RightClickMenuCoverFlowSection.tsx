...
interface RightClickMenuCoverFlowSectionProps {
  activeGame?: Game;
  ...
  onCoverFlowButtonColorsChange?: (colors: ButtonColors) => void;
  onCoverFlowButtonPositionChange?: (pos: 'left' | 'middle' | 'right') => void;
  onCoverFlowCoverSizeChange?: (value: number) => void;
  ...
  renderButtonColorsEditor: (options: {
    title: string;
    colors?: ButtonColors;
...
export function RightClickMenuCoverFlowSection({
  activeGame,
  backgroundBlur,
...
}: RightClickMenuCoverFlowSectionProps) {
  return (
